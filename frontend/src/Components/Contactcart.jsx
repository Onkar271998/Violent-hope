  ...
  const handleSubmit = () => {
    if (!msg.email || !msg.text) {
      ...
      setMsg({
        ...
        text: "Problem faced during making order",
      });
      onClose();
    }
  };
  ...
  return (
    <>
      <Box w={"90%"} m="auto" mt={"20px"}>
        <Text color={"gray"} fontSize="14px" align={"center"}>
          ...
          >
            <VStack>
              ...
              <Box align="center" textDecoration={"underline"}>
                <Text fontSize={["13.5px", "13px", "16px"]}>
                  +49 89 127695-101{" "}
                </Text>
                <Text fontSize={["13.5px", "13px", "16px"]}>
        ...
        >
          <Text>
            copyright © 2006-2022 mytheresa.com terms of use privacy policy
            imprint
          </Text>
